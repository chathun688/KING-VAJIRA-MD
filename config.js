...
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;OriginalPickles",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'CHATHUN',
  botbgm: process.env.BOT_BGM || 'true',
  ownername:  process.env.OWNER_NAME || `CHATHUN`,
